          ...
          >
            ...
            <div className="pt-2 flex flex-col sm:flex-row gap-3 relative z-10">
              <a
                ...
                className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-[#54A1FD] text-white font-medium text-xs sm:text-sm hover:opacity-90 transition-opacity shadow-lg shadow-blue-500/25 no-underline"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl border border-white/15 bg-white/5 hover:bg-white/10 text-zinc-200 text-xs sm:text-sm font-medium transition-colors no-underline"
              >
