    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Logo Track */}
                <ul className="logo-slider__track flex items-center w-fit m-0 p-0 list-none">
                    {logos.map((logo, index) => (
                        <li
                            key={index}
                            className="logo-slider__item h-auto w-[200px] sm:w-[240px] lg:w-[280px] grid place-items-center shrink-0 py-2"
